...
def callback_gazebo_pose(data):
	...
	x_gaze = data.pose[2].position.x
	y_gaze = data.pose[2].position.y
	q_gaze = [data.pose[2].orientation.x,data.pose[2].orientation.y,data.pose[2].orientation.z,data.pose[2].orientation.w]
